...
public class DocumentParser {
	...
	public Columns getOptionData(Document doc) throws Exception {
		...
		Columns columns = updateColumns(doc, lst);
		return columns;
	...
	public Columns updateColumns(Document doc, List<Column> column) {
	...
	public USDINRFuture getFuturePrice(Document doc) {
		try {
			...
			System.out.println("Future Price Data : " + strong.get(0).text());
